      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal leading-[90%] tracking-[-0.03em] text-black mix-blend-exclusion max-w-2xl">
            Ваша реклама там, где люди
          </h1>

          <p className="text-base sm:text-lg md:text-xl leading-[160%] text-black max-w-2xl px-4">
            Размещайте рекламу в автобусах, трамваях и метро — охватывайте миллионы пассажиров каждый день. Эффективный формат с гарантированным результатом.
          </p>
                ...
                <div className="flex-1 flex flex-col justify-center space-y-3 w-full">
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-white leading-[150%]">
                          Подберём маршруты и форматы под ваш бюджет — от бортовой рекламы до цифровых экранов внутри салона.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-white leading-[150%]">
                          Охват от 500 000 пассажиров в день. Ваша реклама работает 24/7 на самых загруженных маршрутах города.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-white/20">
                    <p className="text-lg sm:text-xl lg:text-2xl text-white leading-[150%] mb-4">
                      Реклама в транспорте дала нам рост узнаваемости бренда на 40% за первые два месяца.
                    </p>
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      />
                      <div>
                        <p className="text-base sm:text-lg lg:text-xl text-white">Михаил Орлов</p>
                        <p className="text-sm sm:text-base text-white/70">Директор по маркетингу, ГородМаркет</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <form className="space-y-4 sm:space-y-5">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <div className="sm:w-40 w-full">
                        ...
                        >
                          <option value="board">Бортовая</option>
                          <option value="screen">Экран в салоне</option>
                          <option value="interior">Внутри салона</option>
                          <option value="stop">Остановки</option>
                          <option value="all">Всё сразу</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div>
                      <label
                        ...
                        className="block text-[10px] font-mono font-normal text-white mb-2 tracking-[0.5px] uppercase"
                      >
                        ПОЖЕЛАНИЯ ПО МАРШРУТАМ И БЮДЖЕТУ
                      </label>
                      <textarea
                        id="message"
                        name="message"
